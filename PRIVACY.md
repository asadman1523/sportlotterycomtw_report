...
運彩視覺化UI is a Chrome extension that helps users review and visualize their Taiwan Sports Lottery betting history inside the official website's "My Bets" page.
...
The extension runs on the Taiwan Sports Lottery website and uses data already available in the user's active browser session on that website. The extension is not affiliated with Taiwan Sports Lottery.

## Contact

For questions or issue reports, please use the GitHub issue tracker:

https://github.com/asadman1523/sportlotterycomtw_report/issues
